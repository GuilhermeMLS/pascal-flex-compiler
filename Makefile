...
compilador: lex.yy.c y.tab.c compilador.o compilador.h symbolTable/symbolTable.o stringStack/stringStack.o genericStack/genericStack.o
	gcc lex.yy.c compilador.tab.c compilador.o symbolTable/symbolTable.o stringStack/stringStack.o genericStack/genericStack.o -o compilador -ll -ly -lc

lex.yy.c: compilador.l compilador.h
	flex compilador.l

y.tab.c: compilador.y compilador.h symbolTable/symbolTable.h stringStack/stringStack.h genericStack/genericStack.o
